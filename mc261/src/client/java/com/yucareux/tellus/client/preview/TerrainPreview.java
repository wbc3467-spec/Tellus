...
public final class TerrainPreview implements AutoCloseable {
      ...
      try {
         for (int z = 0; z < size; z++) {
            ...
            for (int x = 0; x < size; x++) {
               ...
               boolean oceanZoom = landMaskSample.known() && landMaskSample.land() ? false : useOceanZoom(landMaskSample, pointCoverClass);
               ...
               oceanFallbackMask[idx] = isPreviewOceanFallback(landMaskSample, surfaceY, pointCoverClass, seaLevel);
   ...
   private boolean useOceanZoom(double blockX, double blockZ, double worldScale, double previewResolutionMeters) {
      ...
      int coverClass = this.landCoverSource.sampleCoverClass(blockX, blockZ, worldScale, previewResolutionMeters);
